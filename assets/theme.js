      ...
      value: function _updateProductPrices(newVariant, previousVariant) {
        ...
        if (!newVariant) {
          ...
          if (newVariant['compare_at_price'] > newVariant['price']) {
            ...
            productMonthlyPrices.innerHTML += "Oder zahlen Sie <span style='color: #ba2e2e' class=\" Price Text--subdued \" data-money-convertible>".concat(Currency.formatMoney(newVariant['price']/12, window.theme.moneyFormat), "</span>/montl");
